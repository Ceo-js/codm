...
<style>
   @font-face {
      ...
      src: url( "../assets/HitmarkerText-Bold.ttf" );
   }
   @font-face {
      font-family: "Hitmarker ";
      src: url( "../assets/HitmarkerText-Regular.ttf" );
   }
...
<AppBar-Body>
   <t1>
      ...
      <br>
      <t>CODM Sensitivity Calculator</t>
   </t1>
</AppBar-Body>
`;
...
addEventListener( "load", ev => {
   ...
   class AppBar extends HTMLElement {
      constructor() {
         super();
         let appbarTag = document.createElement( "template" );
         appbarTag.innerHTML = appbarTemplate;
         // appbar.innerHTML += appbarTemplate;
         this.attachShadow( { mode: "open" } );
         this.shadowRoot.append( appbarTag.content.cloneNode( true ) );
         // this.shadowRoot.append( appbar.innerHTML.content.cloneNode( true ) );
      ...
      connectedCallback() {
         ...
         this.shadowRoot.querySelector( "t1 > svg" ).addEventListener( "click", ev => {
